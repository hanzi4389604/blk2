...
def project_masks_on_boxes(gt_masks, boxes, matched_idxs, M):
  ...
  #  print("rois,boxes ",rois.shape, boxes.shape,len(matched_idxs))
...
def maskrcnn_loss(mask_logits, proposals, gt_masks, gt_labels, mask_matched_idxs):
    ...
    """
  #  print("gt_masks",gt_masks[0].shape)
    #print("mask_logits",mask_logits[0].shape)
    #print("gt_masks length",len(gt_masks))
    # 28(FCN分支输出mask的大小)
    discretization_size = mask_logits.shape[-1]
    #print("discretization_size",discretization_size)
   ...
   # print("mask_targets",mask_targets[0].shape)
...
class RoIHeads(torch.nn.Module):
    ...
    def forward(self,
        ...
        if self.has_mask():
           ...
           # print("mask_logit",mask_logits[0].shape)
         #   print("mask_predictor",self.mask_predictor)
            loss_mask = {}
            if self.training:
