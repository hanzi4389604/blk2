...
class BalancedPositiveNegativeSampler(object):
    ...
    def __call__(self, matched_idxs):
        ...
        neg_idx = []
        # 遍历每张图像的matched_idxs
        #for ii in range(len(matched_idxs)):
        #    print(len(matched_idxs[ii]))
        for matched_idxs_per_image in matched_idxs:
          #  print("matched_idxs_per_image",matched_idxs_per_image[:100])
          ...
          #  between = torch.where(torch.eq(matched_idxs_per_image, -1))[0]
           # print("between ",between.shape)
            # 指定正样本的数量
        ...
        #    print("num_pos",num_pos)
         ...
         #   print("num_neg",num_neg)
          ...
          #  print(len(perm1))
           ...
           # print("pos_idx_per_image]",pos_idx_per_image)
           # print("pos_idx_per_image",pos_idx_per_image.shape)
            ...
            #print("pos_idx_per_image_mask",pos_idx_per_image_mask.shape)
            neg_idx_per_image_mask = torch.zeros_like(
                matched_idxs_per_image, dtype=torch.uint8
            )
          #  print("neg_idx_per_image_mask",neg_idx_per_image_mask.shape)
            pos_idx_per_image_mask[pos_idx_per_image] = 1
            neg_idx_per_image_mask[neg_idx_per_image] = 1
           # print(pos_idx_per_image_mask.shape)
...
class BoxCoder(object):
    ...
    def encode(self, reference_boxes, proposals):
      ...
      #      print("len(b)",len(b))
       # for b in proposals:
      #      print("len(refere)",len(b))
        reference_boxes = torch.cat(reference_boxes, dim=0)
        
        proposals = torch.cat(proposals, dim=0)
        ##print("reference_boxes",reference_boxes[:100])
        #print("proposals",proposals[:100])
    ...
    def decode(self, rel_codes, boxes):
       ...
       # print("concat_boxes",concat_boxes.shape)
        box_sum = 0
        for val in boxes_per_image:
            box_sum += val
         #   print("box_sum",box_sum)
...
class Matcher(object):
    ...
    def __call__(self, match_quality_matrix):
       ...
       # print("match_quality_matrix matched_vals matches", match_quality_matrix.shape, matched_vals.shape, matches.shape)
