...
#from .MultiScaleRoIAlign import MultiScaleRoIAlign
...
class FastRCNNPredictor(nn.Module):
    ...
    def forward(self, x):
        ...
        #print("x dim",x.dim())  dim is 2
       # print("x num_classes",self.in_channels)# in_channels = 1024, num_classes = 21
        x = x.flatten(start_dim=1)
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        if box_roi_pool is None:
            box_roi_pool = MultiScaleRoIAlign(
                featmap_names=['0', '1', '2', '3','4'],  # 在哪些特征层进行roi pooling
                output_size=[7, 7],
                sampling_ratio=2)
