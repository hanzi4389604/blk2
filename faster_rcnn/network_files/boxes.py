...
def clip_boxes_to_image(boxes, size):
   ...
   # print("boxes_x",boxes_x.shape)
    boxes_y = boxes[..., 1::2]  # y1, y2
   # print("boxes_y",boxes_y.shape)
    height, width = size
...
#    print("clipped_boxes",clipped_boxes.shape)
...
def box_iou(boxes1, boxes2):
 ...
 #   print("boxes1, boxes2",boxes1.shape, boxes2.shape)
  #  print("IOU values", iou.shape)
    return iou
